...
{
    /// <summary>基础信息页公共基类（M5：统一忙碌/状态/错误展示与异常转译）。</summary>
    public abstract class BaseInfoPageViewModel : ObservableObject
    {
        private bool _isBusy;
        private string _statusText = string.Empty;
        private string _errorText = string.Empty;

        protected BaseInfoPageViewModel(IApiClient api)
        {
            Api = api;
        }
